...
class MedicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medication" do
    assert_difference('Medication.count') do
      post medications_url, params: { medication: { dosage: @medication.dosage, instructions: @medication.instructions, name: @medication.name } }
    end
  ...
  test "should update medication" do
    patch medication_url(@medication), params: { medication: { dosage: @medication.dosage, instructions: @medication.instructions, name: @medication.name } }
